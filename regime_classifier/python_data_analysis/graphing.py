...
#graph all variables vs time, Can we convert this timestamp to a human readable format?
...
for feature in features:
    ...
    plt.legend()
    plt.savefig(f"C:\\Users\\jackd\\OneDrive\\Documents\\MicroRegimeProject\\python_data_analysis\\graphs\\{feature}.png")
